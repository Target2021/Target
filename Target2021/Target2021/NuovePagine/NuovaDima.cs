...
{
    public partial class NuovaDima : Form
    {
        public NuovaDima()
        {
            InitializeComponent();
        ...
        {
            Target2021DataSet.DimeRow riga = target2021DataSet.Dime.NewDimeRow();
            ...
            try
            {
                ...
                target2021DataSet.Dime.Rows.Add(riga);
                dimeTableAdapter.Update(target2021DataSet.Dime);
            }
            catch (Exception e)
            {
        ...
        private void NuovaDima_Load(object sender, EventArgs e)
        {
